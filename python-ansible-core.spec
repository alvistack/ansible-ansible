...
%fdupes -s %{buildroot}%{python3_sitelib}/ansible
%fdupes -s %{buildroot}%{python3_sitelib}/ansible_core*
%fdupes -s %{buildroot}%{python3_sitelib}/ansible_test*
...
Requires: python3-resolvelib >= 0.8.1
